    ...
    <>
      <section className="relative h-full z-0 lg:py-28 sm:py-20 bg-[url('/images/services_bg.webp')] bg-cover bg-center bg-fixed bg-no-repeat">
        ...
        <div className="text-white lg:max-w-screen-xl sm:max-w-screen-sm md:max-w-screen-md mx-auto text-center">
          <p className="bg-gray-600/40 p-2 w-fit mx-auto text-sm rounded-lg">Services</p>
          <h1 className="lg:text-4xl sm:text-2xl font-medium my-4">
            What can GoSolutions do for you?
          </h1>
          <p className="text-base text-gray-100 leading-6 lg:px-44">
            Seamlessly integrating stunning styles and elements,
      ...
      <section className="py-20">
        <div className="lg:max-w-screen-lg sm:max-w-screen-sm md:max-w-screen-md mx-auto">
          <div className="text-center mb-10">
            <p className="uppercase text-md text-blue-900 font-medium">Services</p>
            <h1 className="lg:text-3xl sm:text-2xl font-medium">Tailored Solutions for Your Unique Needs</h1>
          </div>
          <div className="grid lg:grid-cols-3 sm:grid-cols-1 gap-x-8 gap-y-10">
      ...
      <section className="bg-gray-900 py-20">
        <div className="lg:max-w-screen-lg sm:max-w-screen-sm mx-auto grid lg:grid-cols-2 sm:grid-cols-1 gap-4">
          <div className="relative w-full">
            ...
            />
            <div className="absolute w-20 h-20 rounded-xl bg-blue-700 sm:-bottom-5 lg:bottom-10  lg:right-5 sm:-right-5 z-10"></div>
          </div>
          <div className="text-gray-200 lg:mt-0 sm:mt-10">
            <p className="bg-gray-500/30 text-white p-2 w-fit text-xs rounded-lg">
