...
export const Footer = () => {
    ...
    return (
        <div className='bg-black'>
                            ...
                            {items.map((menu, index) => (
                                <li key={index}>
                                    ...
                                    >
                                        {menu.item}
                                        {(menu.sub || menu.icon) && (
                                            <p className='text-xs lowercase'>{menu.sub}</p>
                                        )}
                                    </Link>
                                </li>
                            ))}
            ...
            <div className="max-w-screen-xl mx-auto flex w-full flex-col items-center justify-center border-t border[1px] border-blue-gray-50 py-4 md:flex-row md:justify-between">
                <p className="mb-4 text-center font-normal text-gray-400 md:mb-0 text-sm">
                    &copy; {currentYear} <Link href="/">GoSolutions</Link>. All
                    Rights Reserved.
                </p>
